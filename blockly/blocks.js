// Copyright: modified from https://github.com/BIPES/BIPES
...
Blockly.Blocks['delay'] = {
  init: function() {
    this.appendValueInput("TIME")
        .setCheck(null)
        .appendField("delay"); //Ready for i18n (see dir msg/<lang>.js)
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown([["seconds","sleep"], ["milliseconds","sleep_ms"], ["microseconds","sleep_us"]]), "SCALE"); //i18n
...
Blockly.Blocks['gpio_set'] = {
  init: function() {
    this.appendValueInput("pin")
        ...
        .setAlign(Blockly.ALIGN_RIGHT)
        //.appendField("set pin");
        .appendField("set output pin");//i18n
...
Blockly.Blocks['pinout'] = {
  update_list: function(load_) {
    ...
    return [
                    ...
                    ["Pin 27 / GPIO21", "21"],
                    ["Pin 29 / GPIO22", "22"],
                    ["Pin 31 / ADC0 / GPIO26", "26"],
                    ["Pin 32 / ADC1 / GPIO27", "27"],
                    ["Pin 34 / ADC2 / GPIO28", "28"],
                    ["Internal Temp Sensor / ADC3", "29"]
                        ];
  },
  refresh: function() {
...
Blockly.Blocks['file_open'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField("open file in binary mode")
